...
import { follow, followerCount, followingCount, followingList, getFollowing, unfollow } from "../controllers/follow.controller.js"
...
router.get("/followList", protectRoute, followingList)
